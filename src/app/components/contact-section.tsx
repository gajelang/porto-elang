...
import { FlickeringGrid } from "@/components/ui/flickering-grid"; // Adjust path if needed
  ...
  return (
    <section id="contact" className="py-16 md:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-3xl font-bold mb-4 mx-5 text-white">
            Tell me about your next project
          </h2>
          <p className="text-lg md:text-xl mx-16 text-white">
